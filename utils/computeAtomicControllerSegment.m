function [ac,c] = computeAtomicControllerSegment(u0,x0,sys,regMode,ellToCompose,rho_if,options)
%
...
Vtraj = sampledFiniteTimeVerificationNew(poly,xtraj.getBreaks(),Qf,rho_if,V,verifOptions);
